...
#ifdef ESP_PLATFORM
// IDF's CONFIG_PTHREAD_TASK_CORE_DEFAULT is -1 ("no affinity"), which
// xTaskCreateStaticPinnedToCore() rejects (valid: 0, 1, tskNO_AFFINITY).
// Map it so adapted thread-creation sites boot instead of asserting.
#include "freertos/task.h"
#define RAOP_TASK_CORE \
    ((CONFIG_PTHREAD_TASK_CORE_DEFAULT) < 0 ? tskNO_AFFINITY : (CONFIG_PTHREAD_TASK_CORE_DEFAULT))
#endif
